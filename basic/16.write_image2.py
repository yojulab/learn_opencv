...
image8 = cv2.imread("datas/images/book.jpg", cv2.IMREAD_COLOR)
if image8 is None: raise Exception("Read Error!") 	# 영상 파일 예외처리
...
cv2.imwrite("datas/images/write_test_16.tif", image16)
cv2.imwrite("datas/images/write_test_32.tif", image32)
